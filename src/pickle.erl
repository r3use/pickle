...
-spec update_dict(Dict::t_dict(), KeyVals::list(), Mod::dict_module()) -> NewStack::list().
...
-spec encode_dict(Dict::t_dict(), Pickle::iolist(), Encoder::#encoder{}, Mod::dict | maps) -> iolist().
